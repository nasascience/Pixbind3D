namespace BBWT.Services.Classes
{
    ...
    public class SecurityService : ISecurityService
    {
        ...
        public User GetUserByTicket(string ticket)
        {
            ...
            var securedTicket = this.context.UserSecurityTickets.FirstOrDefault(entry => entry.Ticket == ticket && entry.ExpiredOn >= DateTime.Now && !entry.IsUsed);
        ...
        public SecurityTicket CheckTicket(string ticket)
        {
            ...
            return this.context.SecurityTickets.FirstOrDefault(entry => entry.Ticket == ticket && entry.ExpiredOn >= DateTime.Now && !entry.IsUsed);
        }
        ...
        public UserSecurityTicket CheckTicketForUser(string ticket, User user)
        {
            ...
            return this.context.UserSecurityTickets.FirstOrDefault(entry => entry.Ticket == ticket && entry.User == user
                && entry.ExpiredOn >= DateTime.Now && !entry.IsUsed);
        }
        ...
        public CompanySecurityTicket CheckTicketForCompany(string ticket, Company company)
        {
            ...
            return this.context.CompanySecurityTickets.FirstOrDefault(entry => entry.Ticket == ticket && 
                entry.Company == company && entry.ExpiredOn >= DateTime.Now && !entry.IsUsed);
        }
        ...
        public void ClearAllInvalidTickets()
        {
            var invalidSecurityTickets =
                this.context.SecurityTickets.Where(it => it.ExpiredOn >= DateTime.Now || it.IsUsed);
            ...
            var invalidUserSecurityTickets =
                this.context.UserSecurityTickets.Where(it => it.ExpiredOn >= DateTime.Now || it.IsUsed);
            ...
            var invalidCompanySecurityTickets =
                this.context.CompanySecurityTickets.Where(it => it.ExpiredOn >= DateTime.Now || it.IsUsed);
