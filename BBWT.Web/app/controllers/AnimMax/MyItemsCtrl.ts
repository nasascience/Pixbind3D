...
module Controllers {
    ...
    export interface IMyItemsCtrlScope extends ng.IScope {
        AnimPage: () => void;
        CharPage: () => void;
        EnvironmentVM: any;
        ...
        constructor(
            ...
            $http.get('api/Products/GetCategories?type=Assets')
                .success((data) => {
                    ...
                    $scope.MyItemsfilters.forEach((item) => {
