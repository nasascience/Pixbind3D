...
module Controllers {
    ...
    export interface ICharCtrlScope extends ng.IScope {
        AnimPage: () => void;
        CharPage: () => void;
        testVM: any;
        siteUrl: any;
        ...
        CharProducts: kendo.data.DataSource;//any;
    ...
    export class CharCtrl {
        ...
        constructor(
            ...
            $http.get('api/Products/GetAllProducts?Type=Char').success((data) => {
                ...
                var MultiSelectBox = kendo.ui.DropDownList.extend({
                    ...
                    init: function (element, options) {
                        ...
                        options.template = kendo.template(
                            kendo.format('<input type="checkbox" id="check_#= {1} #" name="{0}" value="#= {1} #" />&nbsp;<label for="{0}">#= {2} #</label>',// kendo.format('<input type="checkbox" name="{0}" value="#= {1} #" />&nbsp;<label for="{0}">#= {2} #</label>',
