...
module Controllers {
    ...
    export interface IGamesCtrlScope extends ng.IScope {
        AnimPage: () => void;
        CharPage: () => void;
        EnvironmentVM: any;
        ...
        GamesSource: kendo.data.DataSource;
        FilterCheck: (e) => void;
        Gamesfilters: any;
        ShowVideo: (e) => void;
        DownloadDemo: (e) => void;
        ...
        constructor(
            ...
            $http.get('api/Products/GetCategories?type=Games')
                .success((data) => {
                    ...
                    $scope.Gamesfilters.forEach((item) => {
