...
(function (Controllers) {
    var GamesCtrl = (function () {
        function GamesCtrl($scope, $sce, $location, $http, $routeParams, $route, AuthSvc, SearchSvc, dict) {
            var delay = 1000;
            setTimeout(function () {
            ...
            $scope.GamesSource = new kendo.data.DataSource({
                transport: {
                    read: {
                        url: "api/Products/GetAllProducts?Type=Games",
                        dataType: "json"
                    }
                },
                pageSize: 4
            ...
            $http.get('api/Products/GetCategories?type=Games')
                .success(function (data) {
                $scope.Gamesfilters = data;
                $scope.Gamesfilters.forEach(function (item) {
                    console.log(item.Name);
                    filterConditions.push({ field: 'Category', operator: 'eq', value: item.Name });
                });
                //It has to be under the ProjectsSource Variable in order to make it work
                $scope.GamesSource.filter([
                    {
                        "logic": "or",
            ...
            $scope.DownloadDemo = function (e) {
                window.open(e.DemoURLDownload, "_self");
            };
        ...
        GamesCtrl.$inject = ['$scope', '$sce', '$location', '$http', '$routeParams', '$route', 'AuthSvc', 'DictSvc', 'SearchSvc'];
        return GamesCtrl;
    })();
    Controllers.GamesCtrl = GamesCtrl;
})(Controllers || (Controllers = {}));
//# sourceMappingURL=GamesCtrl.js.map