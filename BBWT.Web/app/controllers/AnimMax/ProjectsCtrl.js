...
(function (Controllers) {
    var ProjectsCtrl = (function () {
        function ProjectsCtrl($scope, $sce, $location, $http, $routeParams, $route, AuthSvc, SearchSvc, dict) {
            ...
            $http.get('api/Products/GetCategories?type=Projects')
                ...
                $scope.Projectsfilters.forEach(function (item) {
        ...
        ProjectsCtrl.$inject = ['$scope', '$sce', '$location', '$http', '$routeParams', '$route', 'AuthSvc', 'DictSvc', 'SearchSvc'];
        return ProjectsCtrl;
    })();
    Controllers.ProjectsCtrl = ProjectsCtrl;
