...
(function (Controllers) {
    var MyItemsCtrl = (function () {
        function MyItemsCtrl($scope, $sce, $location, $http, $routeParams, $route, AuthSvc, SearchSvc, dict) {
            var delay = 1000;
            setTimeout(function () {
            ...
            $scope.MyItemsSource = new kendo.data.DataSource({
                transport: {
                    read: {
                        url: "api/Products/GetAllUserItems",
                        dataType: "json"
                    }
                },
                pageSize: 20
            ...
            $http.get('api/Products/GetCategories?type=Assets')
                ...
                $scope.MyItemsfilters = data;
                $scope.MyItemsfilters.forEach(function (item) {
                    console.log(item.Name);
                    //filterConditions.push({ field: 'Category', operator: 'eq', value: item.Name });
                });
                //It has to be under the ProjectsSource Variable in order to make it work
                /*$scope.MyItemsSource.filter([
                    {
                        "logic": "or",
        ...
        MyItemsCtrl.$inject = ['$scope', '$sce', '$location', '$http', '$routeParams', '$route', 'AuthSvc', 'DictSvc', 'SearchSvc'];
        return MyItemsCtrl;
    })();
    Controllers.MyItemsCtrl = MyItemsCtrl;
})(Controllers || (Controllers = {}));
//# sourceMappingURL=MyItemsCtrl.js.map